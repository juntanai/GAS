function VTRMAIL() {
  ...
  var main_text_option = getitem(sw, "D26");

  const recipient = "filmj0222@gmail.com"; //送信先のメールアドレス
  const subject =
    "V" + DAY + " " + fm_time + "挙式" + " " + m_w_name + "受注書";
  const recipientName = "田中　陣";
  ...
  if (url.indexOf(string_check) == "0") {
    ...
    Browser.msgBox("陣さんへのメールが送信されました。Gmailを確認してください");
  } else {
