function ScheduleControl2() {
  class ControlItem {
    ...
    _serchScheduleSheet(day = this.ceremonyDay) {
      ...
      var col = "A";
      var sche_spred = SpreadsheetApp.openByUrl(this.manageSheetUrl);
  ...
  const ItemObj = new ControlItem();

  //  console.log(getItemTest.ceremonyDay)
  ItemObj.writeAnotherSheet();
}
